...
plotAll('mle_SS','q0','n',parList)
plotAll('mle_SS','q0','s',parList)
plotAll('mle_SS','q0','eta',parList)
# Impact of eta on the structural model
plotAll('map_SS','q0','n',parList)
plotAll('map_SS','q0','s',parList)
plotAll('map_SS','q0','eta',parList)
# Make title
