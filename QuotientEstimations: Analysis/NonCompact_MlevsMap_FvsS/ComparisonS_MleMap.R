...
# Goal: 
# Compare mle_SS and map_SS for simulation with xi=0
eta=0
estNames <-list('mle_SS','map_SS')
n=20
s=0.2
xi= 0.2
...
plotAll('mle_SS','phi0','n',parList)
plotAll('mle_SS','phi0','s',parList)
plotAll('mle_SS','phi0','xi',parList)
# Impact of eta on the structural model
plotAll('map_SS','phi0','n',parList)
plotAll('map_SS','phi0','s',parList)
plotAll('map_SS','phi0','xi',parList)
# Make title
